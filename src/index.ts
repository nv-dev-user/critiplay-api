...
import { gameDeletionHandler, gameHandler, gameListHandler, gamePatchHandler } from './routes/game'
import { organizationCreationHandler, organizationDeletionHandler, organizationHandler, organizationPatchHandler } from './routes/organization'

export interface Env { Variables: { supabaseContext: SupabaseContext } }
...
app.delete('/organization/:organizationId', userOnly, organizationDeletionHandler);
